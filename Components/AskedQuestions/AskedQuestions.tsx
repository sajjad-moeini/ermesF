        ...
        <div className="col-span-1">
          <div className=" flex flex-col justify-center items-center mt-10 xl:mt-24 ">
            <AskedQuestionsBoxItem
              ...
              desc="Ermes Trading Limited serves a wide range of industries, including automotive, construction, food and beverage, healthcare, and manufacturing. Our raw materials and industrial machinery are designed to meet the specific needs of each industry, ensuring high performance and reliability."
            />
            <AskedQuestionsBoxItem
              selectedBox={selectedBox}
              setSelectedBox={setSelectedBox}
