  ...
  return (
   ...
   <div className='px-4'>
      <p
         ...
         Our mission is to own and develop financially disciplined businesses that are leaders in responsibility,
         providing best products with superior branded products to target markets.
      </p>
   </div>
